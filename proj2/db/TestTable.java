...
public class TestTable {
    ...
    public void testGetRow() {
        ...
        Table table1 = new Table(tableTitle, namesOfColumns);
        table1.addRow(rowData1);
        table1.addRow(rowData2);
        table1.addRow(rowData3);
        Table table2 = new Table(tableTitle, namesOfColumns);
        table2.addRow(rowData1);
        table2.addRow(rowData2);
        table2.addRow(rowData3);

        assert(table1.getRow(0).equals(table2.getRow(0)));
    }
